...
const selectTriggerVariants = cva(
  "flex h-9 w-full items-center justify-between gap-3 rounded-xl border border-border bg-background px-3 py-2 text-sm transition-all placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 border border-border bg-input cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "hover:bg-accent hover:text-accent-foreground shadow-sm",
        outline: "border-2 hover:border-ring shadow-sm",
        ghost:
